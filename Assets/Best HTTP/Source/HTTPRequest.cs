...
namespace BestHTTP
{
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        /// </summary>
        public bool IsTimedOut { get { return (!this.UseStreaming || (this.UseStreaming && this.EnableTimoutForStreaming)) && this.ProcessingStarted != DateTime.MinValue && DateTime.UtcNow - this.ProcessingStarted > this.Timeout; } }
